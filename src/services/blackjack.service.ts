/* ============================================================================
   ...
   Game logic (pure functions) lives in src/lib/blackjack/.
   DB operations live in repositories.
...
import * as BlackjackRoundRepo from "../repositories/blackjackRound.repository";
import type { BlackjackGameState, DisplayGameState } from "../lib/blackjack";
import {
  dealGame,
  resolveInsurance,
  hitHand,
...
async function persistRound(
  ...
  await BlackjackRoundRepo.createRound({
    userId,
    totalBet,
    totalWin,
    handsSnapshot,
